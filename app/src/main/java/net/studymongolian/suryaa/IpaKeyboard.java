...
public class IpaKeyboard extends Keyboard {
    ...
    public IpaKeyboard(Context context) {
        super(context);
        init(context);
    }

    public IpaKeyboard(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public IpaKeyboard(Context context, AttributeSet attrs, int defStyle) {
